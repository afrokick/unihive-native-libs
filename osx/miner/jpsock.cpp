...
//{
//    jpsock_thd_main();
//    executor::inst()->push_event(ex_event(std::move(sSocketError)));
//
...
//
//    snprintf(cmd_buffer, sizeof(cmd_buffer), "{\"method\":\"job\",\"params\":{\"job_id\":\"%s\",\"blob\":\"%s\",\"target\":\"%s\"}}\n",
//             "11111593-0a26-4825-8565-c4d64eab6bdc", "0606aec28ecf05b9bad631e92fc601050de11fa14fd636d3a1672ea4064e5bf17c7ea7edacb681000000000ce0e1e7b4fc71ae6b7691b9e10c30f1adb5084bac9dc144fa084df6a8ace3100a","ffffff00");
//
//    line = cmd_buffer;
...
//    char cmd_buffer[1024];
//
//    snprintf(cmd_buffer, sizeof(cmd_buffer), "{\"method\":\"login\",\"params\":{\"login\":\"%s\",\"pass\":\"%s\"},\"id\":1}\n",
//        sLogin, sPassword);
//
